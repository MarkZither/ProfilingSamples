...
{
    public class MySqliteStorage : DatabaseStorageBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqliteStorage"/> class with the specified connection string.
        /// </summary>
        /// <param name="connectionString">The connection string to use.</param>
        public MySqliteStorage(string connectionString) : base(connectionString) { }
        ...
        public MySqliteStorage(string connectionString, string profilersTable, string timingsTable, string clientTimingsTable)
...
WHERE NOT EXISTS (SELECT 1 FROM {MiniProfilerClientTimingsTable} WHERE Id = @Id)";
  ...
  SELECT Id as IdString,
         ...
         Name,
         CAST(DurationMilliseconds AS NUMERIC),
         CAST(StartMilliseconds AS NUMERIC),
         IsRoot,
         Depth,
         CustomTimingsJson
...
");
        ...
        public MySqliteStorage WithSchemaCreation(params string[] additionalSqlStatements)
        {
